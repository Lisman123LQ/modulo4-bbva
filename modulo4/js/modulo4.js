...
async function consultarDNI(dni) {
  ...
  try {
    ...
    // Error enviado por la Edge Function
...
async function subirFoto(blob,key){
  ...
  if(error) throw new Error('Esta foto ya fue registrada o no se pudo subir: '+error.message);
  return path;
}
...
async function exportarExcel(){
  ...
  try{
    ...
    const ws=workbook.addWorksheet('MODULO 4');
